...
public class FalseMain {
   ...
   public FalseMain() {
      // first, initialize the web session with user credentials.
      // char[]'s are preferred for sensitive information.
      ...
      // Choose where you want to create the folder and paste the path here.
      // Be sure to append the folderTitle correctly.
